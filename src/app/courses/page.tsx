...
const courses = [
  ...
  },
  {
    ...
    board: "CBSE Board",
    badge: "CBSE",
    tagline: "Score your best in CBSE boards with structured coaching & NCERT-based practice.",
    description:
    ...
    features: [
      ...
      "NCERT-based concept teaching",
      "CBSE sample paper & previous year drills",
      "Weekly chapter-wise tests",
      "Intensive pre-board mock exams",
      "Dedicated doubt-clearing sessions",
      "Monthly parent-teacher meetings",
  ...
  },
  {
    ...
    board: "HSC Maharashtra State Board — Commerce",
    badge: "Foundation",
    tagline: "Build a rock-solid foundation for 12th boards and beyond.",
    description:
      "The 11th Standard is a critical transition year. Our Commerce program ensures students don't just clear the syllabus but deeply understand every concept — building the foundation needed for 12th board excellence.",
    subjects: [
      "Accounts",
      "Economics",
  ...
  },
  {
    ...
    description:
      "12th is the most critical academic year. Our Commerce program is designed to maximize every student's HSC board score through intensive revision, exam strategy, mock tests, and personalized guidance. We leave nothing to chance.",
    subjects: [
      "Accounts",
      "Economics",
      "Mathematics & Statistics",
